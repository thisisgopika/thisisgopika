...
## 📈 Featured Projects
### 🧠 [Query-Aware Semantic Context Compression for RAG](https://github.com/thisisgopika/query-aware-rag)
**Research Project** - Multi-stage context compression pipeline for Retrieval-Augmented Generation
- **Tech Stack:** Python, PyTorch, FLAN-T5, Gemma-2B, Llama 3.1, SentenceTransformers, spaCy, BM25
